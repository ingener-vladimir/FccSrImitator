#ifndef FUNCTIONCONTROL330_H
#define FUNCTIONCONTROL330_H

#include "BaseFunctionControl.h"

class FunctionControl330 : public BaseFunctionControl
{
public:
    FunctionControl330(StructFunctionControl* control);
    ~FunctionControl330() {}
