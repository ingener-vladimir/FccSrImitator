#ifndef FUNCTIONCONTROL345_H
#define FUNCTIONCONTROL345_H

#include "BaseFunctionControl.h"

class FunctionControl345: public BaseFunctionControl
{
public:
    FunctionControl345(StructFunctionControl* control);
    ~FunctionControl345() {}
